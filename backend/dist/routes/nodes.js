...
const router = Router();
// 创建知识点
router.post('/:graphId/nodes', authMiddleware, async (req, res) => {
    try {
...
// 获取知识点详情
router.get('/:graphId/nodes/:nodeId', authMiddleware, async (req, res) => {
    try {
        const graphId = req.params.graphId;
...
// 更新知识点
router.put('/:graphId/nodes/:nodeId', authMiddleware, async (req, res) => {
    try {
        const graphId = req.params.graphId;
        const nodeId = req.params.nodeId;
        const userId = req.user.userId;
...
// 删除知识点
router.delete('/:graphId/nodes/:nodeId', authMiddleware, async (req, res) => {
    try {
        const graphId = req.params.graphId;
        const nodeId = req.params.nodeId;
        const userId = req.user.userId;
